...
nombre = raw_input("ingresa tu nombre: ")  # ingresaremos datos por el teclado
...
if largo < 3: #  condicion minimo tres letras
    ...
    salto = 1 # servira para alternar dic2 y dic3 
    ...
    print "Felcidades tu serial es: " + "".join(serial) + "-" + str(numeros) + " Saludos AbelJM" #  imprime serial 
